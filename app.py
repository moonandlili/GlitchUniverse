...
def tadc_people():
    return render_template("series/tadc/people/index.html")
...
def tadc_creadores():
    return render_template("series/tadc/people/creadores.html")


@app.route("/series/tadc/people/productores")
def tadc_productores():
    return render_template("series/tadc/people/productores.html")


@app.route("/series/tadc/people/actores_voz")
def tadc_actores_voz():
    return render_template("series/tadc/people/actores_voz.html")
...
def md_creadores():
    return render_template("series/md/people/creadores.html")


@app.route("/series/md/people/productores")
def md_productores():
    return render_template("series/md/people/productores.html")


@app.route("/series/md/people/actores_voz")
def md_actores_voz():
    return render_template("series/md/people/actores_voz.html")


@app.route("/series/md/people/otros")
def md_otros():
    return render_template("series/md/people/otros.html")
